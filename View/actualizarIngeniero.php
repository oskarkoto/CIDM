...
<div class="card" id="ListaCompleta">
    <div class="card-title">
        <h2> ACTUALIZAR INGENIERO </h2>
    </div>
    <form method="POST" action="?c=actualizarIngeniero" class='formulario'>
    <?php foreach ($selectIngeniero as $value) { ?>    
        <div class="row" style="margin-left: 2.5rem;">        
            <div class="col-md-6 col-xl-6 col-sm-12" >
                <div class="col-md-12 col-xl-12 col-sm-12" >
                    <label for="idIngeniero" class='label_form'>ID de Ingeniero:</label>
                    <input type="text" class="col-form-label" id="input_form" name="idIngeniero" value="<?php echo $value->idIngeniero; ?>" style="background-color:#f8f8f8; border-color: #d0d0d0" readonly> 
