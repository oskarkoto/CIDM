...
<div class="card" id="ListaCompleta">
    ...
    <div class="card-subtitle" id="Add">
        ...
        <select name="forma" onchange="location = this.value;">
            <option value="?c=detalleAllDispositivo" selected>Dispositivos</option>
            <option value="?c=detalleAllTipoDispositivo">Tipos de Dispositivo</option>            
        </select>
        <!-- Icono filtro -->
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-funnel-fill" viewBox="0 0 16 16">
        <path d="M1.5 1.5A.5.5 0 0 1 2 1h12a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.128.334L10 8.692V13.5a.5.5 0 0 1-.342.474l-3 1A.5.5 0 0 1 6 14.5V8.692L1.628 3.834A.5.5 0 0 1 1.5 3.5v-2z"/>
        </svg>
        <a href="?c=crearDispositivo" class="add">
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col">Fecha Inclusión</th>
                <th scope="col">Opciones</th>
            </tr>
        </thead>
        <tbody>
        <?php
        foreach ($allDispositivo as $value) {    
        ?>
            <tr>
                ...
                <td>
                <a class="ver" id="ver" href="?c=detalleDispositivo&idDispositivo=<?php echo $value->idDispositivo; ?>">
                <!-- Icono Ver -->
                ...
                <br>
                <a class="editar" id="editar" href="?c=actualizarDispositivo&idDispositivo=<?php echo $value->idDispositivo; ?>">
                <!-- Icono Actualizar -->
                ...
                <br>
                <a class="eliminar" id="eliminar" href="?c=eliminarDispositivo&idDispositivo=<?php echo $value->idDispositivo; ?>">
                <!-- Icono Eliminar -->
